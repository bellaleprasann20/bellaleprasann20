...
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=12,20,24&height=200&section=header&text=Prasann%20Bellale&fontSize=52&fontColor=ffffff&fontAlignY=35&desc=MERN%20Stack%20Developer%20%E2%80%A2%20Full%20Stack%20Engineer%20%E2%80%A2%20UI%2FUX%20Craftsman&descAlignY=58&descSize=16&animation=fadeIn" width="100%"/>
...
My engineering approach is grounded in **product thinking**: I don't just write features, I build experiences. Whether it's architecting a real-time messaging system, designing an intuitive UI component library, or wiring up a secure RESTful API, I bring the same attention to detail at every layer of the stack.

Currently completing my **BCA at Guru Nanak First Grade College, Bidar (2022–2025)**, I have sharpened my skills through ambitious full-stack clone projects — rebuilding complex platforms like Airbnb, LinkedIn, Zerodha, and Zoom from the ground up.
...
- Internships and junior engineering programmes
...
[![Languages](https://skillicons.dev/icons?i=html,css,js,typescript,python&theme=dark)](https://skillicons.dev)

**Frontend**

[![Frontend](https://skillicons.dev/icons?i=react,nextjs,redux,tailwind,bootstrap,vite&theme=dark)](https://skillicons.dev)

**Backend & Databases**

[![Backend](https://skillicons.dev/icons?i=nodejs,express,mongodb,mysql,firebase,redis&theme=dark)](https://skillicons.dev)

**Cloud, DevOps & Tooling**

[![DevOps](https://skillicons.dev/icons?i=git,github,vercel,netlify,postman,vscode&theme=dark)](https://skillicons.dev)
...
<details>
<summary><b>◈ Airbnb Clone — Full-Featured Vacation Rental Platform</b></summary>

<br/>

> A full-stack vacation rental marketplace replicating core Airbnb functionality including property listings, search and filtering, user authentication, booking management, and host dashboards — built with the MERN stack.

<br/>

| Attribute | Details |
|:---|:---|
| **Stack** | React · Node.js · Express.js · MongoDB · Tailwind CSS · Cloudinary |
| **Scale** | Multi-user · property listing CRUD · image upload pipeline |
...
<details>
<summary><b>◈ Zerodha Clone — Stock Trading Application Interface</b></summary>

<br/>

> A pixel-faithful recreation of the Zerodha trading platform frontend, featuring live-style stock dashboards, portfolio views, order management UI, and interactive charting components.

<br/>

| Attribute | Details |
|:---|:---|
| **Stack** | React · Node.js · Express.js · MongoDB · Chart.js · CSS Modules |
| **Scale** | Multi-route SPA · dynamic data rendering · real-time chart simulation |
...
<details>
<summary><b>◈ Chat App — Real-Time Messaging Application</b></summary>

<br/>

> A full-stack real-time chat application supporting one-to-one messaging, online presence indicators, and message history — built on WebSocket communication via Socket.io.
...
| **Scale** | Multi-user real-time rooms · persistent message history |
...
<details>
<summary><b>◈ LinkedIn Clone — Professional Networking Platform</b></summary>

<br/>

> A full-stack professional networking platform clone featuring user profiles, connection requests, a dynamic post feed, and a notification system — mirroring LinkedIn's core social graph functionality.
...
|:---|:---|
| **Stack** | React · Node.js · Express.js · MongoDB · Tailwind CSS · Cloudinary |
| **Scale** | Social graph · feed algorithm · notification system · profile management |
...
<details>
<summary><b>◈ GitHub Clone — Code Repository Management System</b></summary>

<br/>

> A GitHub-inspired repository management interface featuring user profiles, repository creation, file browsing, and a contribution activity dashboard — built to explore developer tooling UI patterns.

<br/>

| Attribute | Details |
|:---|:---|
| **Stack** | React · Node.js · Express.js · MongoDB · GitHub OAuth · Tailwind CSS |
| **Scale** | OAuth login · repository CRUD · user dashboard · activity tracking |
...
<details>
<summary><b>◈ Zoom Clone — Video Conferencing Application</b></summary>

<br/>

> A real-time video conferencing application supporting multi-participant video calls, screen sharing, in-call chat, and room management — powered by WebRTC peer-to-peer communication.

<br/>

| Attribute | Details |
|:---|:---|
| **Stack** | React · Node.js · Express.js · Socket.io · WebRTC · PeerJS |
| **Scale** | Multi-participant rooms · real-time AV streams · in-call messaging |
...
<details>
<summary><b>◈ Food Hub — Restaurant & Food Delivery Platform</b></summary>

<br/>

> A food ordering and delivery platform featuring restaurant listings, menu browsing, cart management, order tracking, and a responsive checkout flow — inspired by Zomato and Swiggy.

<br/>

| Attribute | Details |
|:---|:---|
| **Stack** | React · Node.js · Express.js · MongoDB · Tailwind CSS · Razorpay |
| **Scale** | Multi-restaurant · item catalogue · cart state · order management |
...
Pursuing a comprehensive foundation in computer science — covering data structures, algorithms, database management, software engineering principles, and web technologies. Supplemented formal education with extensive self-directed project development across the full MERN stack.
...
![Express.js](https://img.shields.io/badge/Express.js-4C1D95?style=flat-square&logo=express&logoColor=white)
...
current_focus:
  learning:
    - "TypeScript: advanced generics, utility types, and type-safe API design"
    - "Next.js App Router: server components, streaming, and edge deployment"
    - "System design fundamentals: caching, load balancing, database scaling"

  building:
    - "Personal portfolio site with animated project case studies"
    - "Open source MERN starter kit with auth, testing, and CI/CD pre-wired"
    - "Contributing to React and Node.js ecosystem open source projects"

  exploring:
    - "AI integrations in full-stack apps using OpenAI and LangChain"
    - "Docker and containerisation for reproducible development environments"
    - "PostgreSQL and relational modelling as a complement to MongoDB"

  open_to:
    - "Full Stack Developer and MERN Developer roles"
    - "Frontend Engineering internships and junior positions"
    - "Freelance web development projects"
